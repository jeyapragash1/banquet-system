                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('inventory-items.update', $inventoryItem) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="category" class="block mt-1 w-full" type="text" name="category" :value="old('category', $inventoryItem->category)" required />
                            <p class="text-sm text-gray-500 mt-1">e.g., Furniture, Electronics, Decor, Linens</p>
                        </div>

                        <!-- Current Quantity -->
                        <div class="mt-4">
                            <x-input-label for="quantity" :value="__('Current Stock Quantity')" />
